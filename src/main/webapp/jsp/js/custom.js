    ...
    var mainApp = {
        ...
        main_fun: function () {
            ...
            $(function () {
                $.vegas('slideshow', {
                    backgrounds: [
                      { src: './jsp/img/1.jpg', fade: 1000, delay: 9000 },
                      { src: './jsp/img/2.jpg', fade: 1000, delay: 9000 },
                        
                     
                    ]
                })('overlay', {
                    /** SLIDESHOW OVERLAY IMAGE **/
                    src: './jsp/plugins/vegas/overlays/03.png' // THERE ARE TOTAL 01 TO 15 .png IMAGES AT THE PATH GIVEN, WHICH YOU CAN USE HERE
                });
